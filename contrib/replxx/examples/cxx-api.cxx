...
int main( int argc_, char** argv_ ) {
	...
	rx.bind_key_internal( Replxx::KEY::control( 'W' ),                 "kill_to_whitespace_on_left" );
...
#endif
	rx.bind_key_internal( Replxx::KEY::meta( Replxx::KEY::BACKSPACE ), "kill_to_begining_of_word" );
